...
function openProductPage(id) {
    ...
    updateProductPageTotal(product.price);
...
function updateProductPageTotal(basePrice) {
    let total = basePrice;
    const optionsContainer = document.getElementById('product-page-options');
    if (optionsContainer) {
    ...
    const totalBtn = document.getElementById('product-page-total-btn');
    if (totalBtn) {
        totalBtn.innerText = formatPrice(total);
    }
}
